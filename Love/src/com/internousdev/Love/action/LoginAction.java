...
public class LoginAction extends ActionSupport implements SessionAware{
	...
	private List<String> userEqualsErrorMessageList=new ArrayList<String>();
	...
	public String execute() {
		...
		if(loginIdErrorMessageList.size()==0
			...
			}else if(!loginId.equals(dto.getLoginId()) || !loginPassword.equals(dto.getLoginPassword())) {
				userEqualsErrorMessageList.add("ログインIDかパスワードが異なります");
				ret=ERROR;
			}else {
				userEqualsErrorMessageList.add("ユーザー情報がありません");
				ret=ERROR;
			}
		}
	...
	public List<String> getUserEqualsErrorMessageList() {
		return userEqualsErrorMessageList;
	}
	public void setUserEqualsErrorMessageList(List<String> userEqualsErrorMessageList) {
		this.userEqualsErrorMessageList = userEqualsErrorMessageList;
	}
